...
public class InClass0809 extends AppCompatActivity implements IconnectToActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_class0809);
...
//        Fetch the collection of chat records from users tree for current user...
    ...
    @Override
    public void populateEditProfileFragment() {
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.containerMain, FragmentEditProfile.newInstance(),
                        "editProfileFragment")
                .addToBackStack(null)
                .commit();
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(InClass0809.this, "An error occured! Try again!", Toast.LENGTH_SHORT).show();
                            populateScreen();
                        }
                    }
                });
